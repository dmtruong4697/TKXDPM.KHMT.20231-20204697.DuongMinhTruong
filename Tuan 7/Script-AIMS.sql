...
CREATE INDEX `aims`.`Order_fk_Order_DeliveryInfo1_idx` ON `Order`(`deliveryInfoId`);
...
CREATE INDEX `aims`.`OrderMedia_fk_OrderMedia_Order_idx` ON `OrderMedia`(`orderID`);
CREATE INDEX `aims`.`OrderMedia_fk_OrderMedia_Media1_idx` ON `OrderMedia`(`mediaId`);
...
CREATE INDEX `aims`.`Invoice_fk_Invoice_Order1_idx` ON `Invoice`(`orderId`);
...
CREATE INDEX `aims`.`PaymentTransaction_fk_PaymentTransaction_Card1_idx` ON
`PaymentTransaction`(`cardId`);
CREATE INDEX `aims`.`PaymentTransaction_fk_PaymentTransaction_Invoice1_idx`
